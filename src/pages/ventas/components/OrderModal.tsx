    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      <AnimatedSection delay={0.1}>
        <motion.div
          ...
          exit={{ opacity: 0, y: 20 }}
          className="bg-white rounded-xl shadow-2xl w-[96vw] max-w-7xl mx-4 max-h-[90vh] overflow-hidden"
        >
          {/* Header */}
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between text-lg font-bold pt-2 border-t border-gray-200">
                        ...
                        <span className="text-gray-900">${selectedProduct.totalPrice.toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                      ...
                      <a
                        ...
                        className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white py-3 px-4 rounded-lg transition-colors w-full mb-4"
                      >
